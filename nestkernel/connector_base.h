...
public:
  ...
  virtual void adjust_weight( const adjustentry &a, const double t_lastspike_post_syn ) = 0;
...
public:
  ...
  void adjust_weight( const adjustentry &a, const double t_lastspike_post_syn );
